                    ...
                    <div className="pt-10 bg-gray-900 sm:pt-16 lg:pt-8 lg:pb-14 lg:overflow-hidden">
                      ...
                      <span
                        ...
                        WELCOME!
                                            ...
                                            <span className="ml-4 text-sm">Be apart of our community discord</span>
                                            <ChevronRightIcon className="ml-2 w-5 h-5 text-gray-500"
                                                              aria-hidden="true"/>
                                        </a>
                                        <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                                            <span className="block">Developer First</span>
                                            <span className="pb-3 block bg-clip-text text-indigo-400  sm:pb-5">
                        PropTech Simplified
                      </span>
                                        </h1>
                                            ...
                                            <form action="#" className="sm:max-w-xl sm:mx-auto lg:mx-0">
                                                <div className="sm:flex">
                                                    ...
                                                    <div className="mt-3 sm:mt-0 sm:ml-3">
                                                        <button
                                                            type="submit"
                                                            className="block w-full py-3 px-4 rounded-md shadow bg-indigo-500 text-white font-medium hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-400 focus:ring-offset-gray-900"
                                                        >
                                                            Start free trial
                                                        </button>
                                                    </div>
